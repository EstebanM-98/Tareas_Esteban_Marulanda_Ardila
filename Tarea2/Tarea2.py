...
print('r,theta y phi de la suma de los dos vectores es respectivamente:') #Sobre carga suma
suma=vector_esfericas+vector_esfericas1
suma.Print()
...
print('r,theta y phi de la suma de los dos vectores es respectivamente:') #Sobre carga suma, y suma los vectores en cartesianas, por eso el resultado esta en cartesianas
resta=vector_esfericas-vector_esfericas1
resta.Print()
...
print('r,theta y phi del producto cruz entre los dos vectores en esfericas es respectivamente:')
prodcruz=vector_esfericas.Cruz(vector_esfericas1)
prodcruz.Print()
